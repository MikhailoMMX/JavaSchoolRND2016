...
public class Assembly extends ru.sbt.les18_DesignPatterns.structural.compositer09.Item {

    public List<ru.sbt.les18_DesignPatterns.structural.compositer09.Item> itemList;
